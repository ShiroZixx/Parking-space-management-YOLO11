...
from custom_ui.custom_ultralytics_2 import BaseSolution, SolutionAnnotator, SolutionResults
...
class ParkingPtsSelection:
    ...
    def save_to_json(self) -> None:
        ...
        with open("../draw_bbox/bounding_boxes.json", "w", encoding="utf-8") as f:
