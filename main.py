import cv2
import json
from custom_ui.custom_ultralytics_1 import ParkingManagement
...
combine_points_files('draw_bbox/bounding_boxes.json', 'draw_bbox/bounding_boxes_2.json', 'all_points.json')
